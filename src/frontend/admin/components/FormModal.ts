...
import { suggestTagsForContent, executeFormAiAction, openFormAiMenu, closeFormAiMenu } from "../actions/ai";
...
export function FormModal() {
  ...
  function getSuggestions(): string[] {
    ...
    return availableTags.val
      .filter(
        (t) =>
          !formTags.val.includes(t) && t.toLowerCase().includes(input),
      )
      .slice(0, 8);
  }
            ...
            onkeydown: (e: KeyboardEvent) => {
              ...
              if (e.key === "ArrowDown") {
                ...
                if (
                  ...
                  selectSuggestion(
                    suggestions[tagAutocompleteHighlight.val]!,
                  );
                } else {
